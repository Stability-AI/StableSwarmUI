   ...
   addAxis() {
    ...
    register() {
        ...
        this.settingsDiv.innerHTML =
            ...
            + makeTextInput(null, 'grid-gen-output-folder-name', 'Output Folder Name', 'Name of the folder to save this grid under in your Image History.', '', 1, 'Output folder name...', false, true)
            + '<br>'
